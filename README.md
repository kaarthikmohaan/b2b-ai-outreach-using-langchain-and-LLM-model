...
├── chains.py                   # Contains logic for LLM prompting
├── portfolio.py                # Portfolio vector matching engine
├── utils.py                    # Text cleaning and skill synonym normalization
└── company_portfolio.csv       # Tech stack → portfolio link mappings
```
